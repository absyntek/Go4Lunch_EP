...
import com.EtiennePriou.go4launch.ui.fragments.workmates_list.WorkmateFragment.OnListFragmentInteractionListener;
...
public class MyWorkmateRecyclerViewAdapter extends RecyclerView.Adapter<MyWorkmateRecyclerViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mIdView = (TextView) view.findViewById(R.id.tvNamePlace);
            mContentView = (TextView) view.findViewById(R.id.tvAdressePlace);
        }
